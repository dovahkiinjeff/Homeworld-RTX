...
/* Does this need to be in here? Useful but possibly may cause problems */
    ...
    {"exclusiveFullscreen", scriptSetUdwordCB, &mainExclusiveFullscreen},
    {"refreshRate",         scriptSetUdwordCB, &mainRefreshRate},
    {"uiScalePercent",      scriptSetUdwordCB, &mainUIScalePercent},
    {"raytracing",          scriptSetUdwordCB, &mainRaytracing},
    {"fxLightStrength",      scriptSetUdwordCB, &mainFxLightingStrengthPercent},
    {"weaponOriginLightIntensity", scriptSetUdwordCB, &mainWeaponOriginLightIntensityPercent},
    {"weaponOriginLightRange", scriptSetUdwordCB, &mainWeaponOriginLightRangePercent},
    {"weaponImpactLightIntensity", scriptSetUdwordCB, &mainWeaponImpactLightIntensityPercent},
    {"weaponImpactLightRange", scriptSetUdwordCB, &mainWeaponImpactLightRangePercent},
    {"dlaa",                scriptSetUdwordCB, &mainDlaa},
    {"antiAliasing",        scriptSetUdwordCB, &mainDlaa},
    {"frameGeneration",     scriptSetUdwordCB, &mainFrameGeneration},
    {"pathSamples",         scriptSetUdwordCB, &mainPathTracingSamples},
    {"pathBounces",         scriptSetUdwordCB, &mainPathTracingBounces},
    {"generatedNormals",    scriptSetUdwordCB, &mainGeneratedNormalStrengthPercent},
    {"environmentLight",    scriptSetUdwordCB, &mainEnvironmentLightingPercent},
    {"authoredLight",       scriptSetUdwordCB, &mainAuthoredLightingPercent},
    {"surfaceReflectivity", scriptSetUdwordCB, &mainSurfaceReflectivityPercent},
    {"surfaceRoughness",    scriptSetUdwordCB, &mainSurfaceRoughnessPercent},
    {"lightingExposure",    scriptSetUdwordCB, &mainLightingExposurePercent},
    {"chromaticAberration", scriptSetUdwordCB, &mainChromaticAberrationPercent},
    {"motionBlur",          scriptSetUdwordCB, &mainMotionBlurPercent},
    {"filmGrain",           scriptSetUdwordCB, &mainFilmGrainPercent},
    {"godRays",             scriptSetUdwordCB, &mainGodRaysPercent},
    {"bloom",               scriptSetUdwordCB, &mainBloomPercent},
    {"shadowStrength",        scriptSetUdwordCB, &mainShadowStrengthPercent},
    {"sunShadowRadiusCentiDeg",scriptSetUdwordCB, &mainSunShadowAngularRadiusCentidegrees},
    {"sunShadowSamples",      scriptSetUdwordCB, &mainSunShadowSamples},
    {"localShadowSamples",    scriptSetUdwordCB, &mainLocalShadowSamples},
    {"localShadowRadiusCentiDeg", scriptSetUdwordCB, &mainLocalShadowAngularRadiusCentidegrees},
    {"shadowReceiverBiasHundredths", scriptSetUdwordCB, &mainShadowReceiverBiasHundredths},
    {"shadowNormalBiasHundredths", scriptSetUdwordCB, &mainShadowNormalBiasHundredths},
    {"contactShadowStrength", scriptSetUdwordCB, &mainContactShadowStrengthPercent},
    {"contactShadowDistance", scriptSetUdwordCB, &mainContactShadowDistance},
    {"shadowMaximumDistance", scriptSetUdwordCB, &mainShadowMaximumDistance},
  ...
  {"\n[input options]\n", scriptSetStringCB, &filecfgblankspace},
    ...
    {"FOCUS_LAST",              scriptSetUdwordCB, &kbKeySavedKeys[kbFOCUS_LAST]},
    {"HYPERSPACE",              scriptSetUdwordCB, &kbKeySavedKeys[kbHYPERSPACE]},
    {"RETIRE",                  scriptSetUdwordCB, &kbKeySavedKeys[kbRETIRE]},
    {"PAUSE_GAME",              scriptSetUdwordCB, &kbKeySavedKeys[kbPAUSE_GAME]},
    {"FLEET_VIEW",              scriptSetUdwordCB, &kbKeySavedKeys[kbFLEET_VIEW]},
    {"TACTICS_EVASIVE",         scriptSetUdwordCB, &kbKeySavedKeys[kbTACTICS_EVASIVE]},
    {"TACTICS_NEUTRAL",         scriptSetUdwordCB, &kbKeySavedKeys[kbTACTICS_NEUTRAL]},
    {"TACTICS_AGGRESSIVE",      scriptSetUdwordCB, &kbKeySavedKeys[kbTACTICS_AGGRESSIVE]},
    {"FORMATION_DELTA",         scriptSetUdwordCB, &kbKeySavedKeys[kbFORMATION_DELTA]},
    {"FORMATION_BROAD",         scriptSetUdwordCB, &kbKeySavedKeys[kbFORMATION_BROAD]},
    {"FORMATION_DELTA3D",       scriptSetUdwordCB, &kbKeySavedKeys[kbFORMATION_DELTA3D]},
    {"FORMATION_CLAW",          scriptSetUdwordCB, &kbKeySavedKeys[kbFORMATION_CLAW]},
    {"FORMATION_WALL",          scriptSetUdwordCB, &kbKeySavedKeys[kbFORMATION_WALL]},
    {"FORMATION_SPHERE",        scriptSetUdwordCB, &kbKeySavedKeys[kbFORMATION_SPHERE]},
    {"FORMATION_PICKET",        scriptSetUdwordCB, &kbKeySavedKeys[kbFORMATION_PICKET]},
    {"ZOOM_IN",                 scriptSetUdwordCB, &kbKeySavedKeys[kbZOOM_IN]},
    {"ZOOM_OUT",                scriptSetUdwordCB, &kbKeySavedKeys[kbZOOM_OUT]},
    {"CONTROL_GROUP_0",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_0]},
    {"CONTROL_GROUP_1",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_1]},
    {"CONTROL_GROUP_2",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_2]},
    {"CONTROL_GROUP_3",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_3]},
    {"CONTROL_GROUP_4",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_4]},
    {"CONTROL_GROUP_5",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_5]},
    {"CONTROL_GROUP_6",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_6]},
    {"CONTROL_GROUP_7",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_7]},
    {"CONTROL_GROUP_8",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_8]},
    {"CONTROL_GROUP_9",         scriptSetUdwordCB, &kbKeySavedKeys[kbCONTROL_GROUP_9]},
    {"MULTIPLAYER_CHAT",        scriptSetUdwordCB, &kbKeySavedKeys[kbMULTIPLAYER_CHAT]},
    {"CHAT_HISTORY_UP",         scriptSetUdwordCB, &kbKeySavedKeys[kbCHAT_HISTORY_UP]},
    {"CHAT_HISTORY_DOWN",       scriptSetUdwordCB, &kbKeySavedKeys[kbCHAT_HISTORY_DOWN]},
    {"SCREENSHOT",              scriptSetUdwordCB, &kbKeySavedKeys[kbSCREENSHOT]},
    {"MUSIC_PREVIOUS",          scriptSetUdwordCB, &kbKeySavedKeys[kbMUSIC_PREVIOUS]},
    {"MUSIC_NEXT",              scriptSetUdwordCB, &kbKeySavedKeys[kbMUSIC_NEXT]},
    {"KeyBindingsVersion",      scriptSetUdwordCB, &kbKeyBindingsVersion},
    {"opMouseSens",             scriptSetUdwordCB, &opMouseSens},
    {"mouseCursorScalePercent", scriptSetUdwordCB, &mouseCursorScalePercent},
  ...
  {"\n[player preferences]\n", scriptSetStringCB, &filecfgblankspace},
    ...
    {"PlayerEngineTrailColor",  scriptSetUdwordCB, &utyEngineTrailColor},
    {"PlayerEngineTrailOverride", scriptSetBool, &utyEngineTrailColorOverride},
    {"PlayerNavLightColor",     scriptSetUdwordCB, &utyNavLightColor},
    {"PlayerNavLightOverride",  scriptSetBool, &utyNavLightColorOverride},
    {"PlayerResourceBeamColor", scriptSetUdwordCB, &utyResourceBeamColor},
    {"PlayerResourceBeamOverride", scriptSetBool, &utyResourceBeamColorOverride},
    {"PlayerHyperspaceColor", scriptSetUdwordCB, &utyHyperspaceColor},
    {"PlayerHyperspaceOverride", scriptSetBool, &utyHyperspaceColorOverride},
  ...
  {"\n[New HWSDL Options]\n", scriptSetStringCB, &filecfgblankspace},
    ...
    {"UnlimitedFuel",                  scriptSetUdwordCB, &opUnlimitedFuel},
    {"SuperSalvagers",                 scriptSetUdwordCB, &opSuperSalvagers},
    {"CaptureBuildAll",                scriptSetUdwordCB, &opCaptureBuildAll},
    {"ResourceMultiplier",             scriptSetUdwordCB, &opResourceMultiplier},
...
/*-----------------------------------------------------------------------------
    ...
    Return      :
----------------------------------------------------------------------------*/
bool32 utyOptionsFileRead(void)
{
#ifdef _WINDOWS
    ...
    strcpy(optionsPath, ch_buf);
    strcat(optionsPath, UTY_CONFIG_FILENAME);
    optionsFile = fopen(optionsPath, "rt");
    optionsExist = optionsFile != NULL;
    if (optionsFile != NULL)
    {
        fclose(optionsFile);
    }
    ...
    if (mouseCursorScalePercent < 25) mouseCursorScalePercent = 25;
    if (mouseCursorScalePercent > 100) mouseCursorScalePercent = 100;
...
void utyOptionsFileWrite(void)
{
    ...
    {
#ifdef _WINDOWS
        pathLength = snprintf(ch_buf, sizeof(ch_buf), "%s\\%s\\%s",
                              home_dir, CONFIGDIR, UTY_CONFIG_FILENAME);
#else
        pathLength = snprintf(ch_buf, sizeof(ch_buf), "%s/%s/%s",
                              home_dir, CONFIGDIR, UTY_CONFIG_FILENAME);
#endif
    ...
    {
        pathLength = snprintf(ch_buf, sizeof(ch_buf), "%s", UTY_CONFIG_FILENAME);
    }

    if (pathLength < 0 || pathLength >= (int)sizeof(ch_buf))
    {
        fprintf(stderr, "Unable to save options: settings path is too long.\n");
        return;
    }

    if (!fileMakeDestinationDirectory(ch_buf))
    {
        fprintf(stderr, "Unable to save options: cannot create directory for %s.\n",
                ch_buf);
        return;
    }
    ...
    if (f == NULL)
    {
        fprintf(stderr, "Unable to save options: cannot open %s.\n", ch_buf);
        return;
    }
...
color utyEngineTrailColor = colRGB(48, 176, 255);
color utyNavLightColor = colRGB(80, 196, 255);
color utyResourceBeamColor = colRGB(255, 72, 124);
color utyHyperspaceColor = colRGB(86, 120, 255);
bool32 utyEngineTrailColorOverride = FALSE;
bool32 utyNavLightColorOverride = FALSE;
bool32 utyResourceBeamColorOverride = FALSE;
bool32 utyHyperspaceColorOverride = FALSE;
...
/*-----------------------------------------------------------------------------
    ...
    Return      : void
----------------------------------------------------------------------------*/
static void utyStartupStage(const char *stage)
{
...
void utyFrontEndDataLoad(void)
{
    ...
    utyStartupStage("default front-end font begin");
    ghDefaultFont = frFontRegister("default.hff");          //load in the default font
    fontMakeCurrent(ghDefaultFont);                         //make default font current
    utyStartupStage("default front-end font complete");

    for (index = 0; utyFrontEndFiles[index] != NULL; index++)
    {
        fprintf(stderr, "[Startup] front-end file %d begin: %s\n",
                index, utyFrontEndFiles[index]);
        fflush(stderr);
        utyFrontEndFiles[index] = (char *)feScreensLoad(utyFrontEndFiles[index]);
        fprintf(stderr, "[Startup] front-end file %d complete\n", index);
        fflush(stderr);
    }
    utyStartupStage("front-end callbacks begin");
    feCallbackAddMultiple(utyCallbacks);
    feDrawCallbackAddMultiple(utyDrawCallbacks);
    utyStartupStage("front-end callbacks complete");

    utyStartupStage("options UI initialization begin");
    opOptionsInit();
    utyStartupStage("options UI initialization complete");
}
...
char *utyGameSystemsInit(void)
{
    ...
    utyStartupStage("language and strings begin");
    ...
    utySet2(SS2_Strings);
    utyStartupStage("language and strings complete");
    ...
    utyStartupStage("archive CRC calculation complete");
    ...
    utySet(SSA_Timer);
    utyStartupStage("SDL timer ready");
                                                            //start the task manager
    taskStartup((udword)(1000 / utyTimerDivisor));
    utySet(SSA_Task);
    utyStartupStage("task manager ready");
    ...
    utySet(SSA_Region);
    utyStartupStage("region processor ready");

    // initialize sound engine
    soundEventInit();
    utySet2(SS2_SoundEngine);
    utyStartupStage("sound engine ready");
    ...
    utyStartupStage("renderer initialization begin");
    ...
    utyStartupStage("renderer initialization complete");

    uiScaleConfigure(MAIN_WindowWidth, MAIN_WindowHeight, mainUIScalePercent);
    fprintf(stderr, "UI scale: %.2fx at %dx%d (%d%% automatic modifier).\n",
            uiScaleGet(), MAIN_WindowWidth, MAIN_WindowHeight,
            mainUIScalePercent);
    ...
    utyStartupStage("lights and texture registry ready");
    ...
    universeInit();
    utySet(SSA_Universe);
    utyStartupStage("universe ready");
    ...
    utySet(SSA_FEFlow);
    utyStartupStage("front-end flow ready");
#if MAIN_MOUSE_FREE
    utyClipMouse(startupClipMouse);                         //clip mouse to window if needed
#endif
    utySet(SSA_MouseClipped);

    utyStartupStage("front-end data load begin");
    utyFrontEndDataLoad();
    utySet(SSA_FrontEndData);
    utyStartupStage("front-end data load complete");

    tacticsStartUp();
    utyStartupStage("tactics ready");
    ...
    utyStartupStage("launch, trade, and research managers ready");
    ...
    utyStartupStage("sensors, ship view, ping, and battle chatter ready");
    ...
    utyStartupStage("teams, colors, subtitles, and tutorial ready");
    ...
    utyStartupStage("scenario and game pickers ready");
    ...
    nisStartup();
    utySet2(SS2_NIS);
    utyStartupStage("construction, random, spline, and NIS systems ready");
    ...
    utyStartupStage("render-effect systems ready");
    ...
    utyStartupStage("front-end texture registry ready");

    utyStartupStage("primitive renderer begin");
    prim3dStartup();                                        //start the prim 3d stuff
    utySet2(SS2_Prim3D);
    utyStartupStage("primitive renderer ready");

    utySystemStarted = TRUE;

    utyStartupStage("settings application begin");
    opUpdateSettings();
    utyStartupStage("settings application complete");

    utyStartupStage("front-end music begin");
    soundEventPlayMusic(SOUND_FRONTEND_TRACK);
    utyStartupStage("front-end music complete");
    utyStartupStage("front-end content ready");

//    if (!nisEnabled)
//    {
        utyStartupStage("main screen activation begin");
        feScreenStart(ghMainRegion, "Main_game_screen");
        mouseCursorShow();
        utyStartupStage("main screen activation complete");
//    }
...
*/
    ...
    utyStartupStage("all game systems ready");
...
bool32 utyChangeResolution(sdword width, sdword height, sdword depth) {
    ...
    uiScaleConfigure(width, height, mainUIScalePercent);

...
/* User-facing cursor-size multiplier. 100 preserves the current modern/UI-
   scaled cursor size; gameplay options clamp it to 25..100 percent. */
extern sdword mouseCursorScalePercent;
...
/* SDL can deliver several wheel notches in one event.  Preserve the complete
   signed delta until the deepest region beneath the cursor consumes it. */

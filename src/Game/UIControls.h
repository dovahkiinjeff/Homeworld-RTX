...
/* Region scrolling moves the control rectangle but the original UI code kept
   the thumb geometry as separate absolute coordinates.  Rebase those cached
   rectangles after a parent screen is moved or responsively anchored. */
void uicScrollBarSynchronizeGeometry(scrollbarhandle scrollbar);

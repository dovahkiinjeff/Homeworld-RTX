...
/* DXR-only shadow submission for solid ships culled from the raster camera. */
void meshSubmitRaytracingShadow(meshdata *mesh, sdword iColorScheme);
void meshSubmitRaytracingShadowShipHierarchy(shipbindings *bindings, sdword currentLOD,

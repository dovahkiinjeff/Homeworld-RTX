...
#define RM_TechInfoFont     "HW_EuroseCond_11.hff"
...
#define RM_SelectionTextColor     colRGB(225, 222, 206)
#define RM_ResearchingTextColor   colRGB(222, 162, 62)
#define RM_CantResearchTextColor  colRGB(74, 82, 84)
#define RM_StandardTextColor      colRGB(143, 157, 157)
#define RM_ClassHeadingTextColor  colRGB(222, 162, 62)
#define RM_ProgressToGoColor      colRGB(86, 111, 120)
#define RM_ProgressDoneColor0     colRGB(24, 36, 43)
#define RM_ProgressDoneColor1     colRGB(105, 184, 196)
#define RM_LabActiveColor         colRGB(105, 184, 196)
#define RM_PulseColor             colRGB(222, 162, 62)
#define RM_NoResearchItemColor    colRGB(151, 83, 70)
#define RM_MarqueeOnColor         colRGB(222, 162, 62)
#define RM_MarqueeSemiOnColor     colRGB(143, 112, 62)
#define RM_MarqueeOffColor        colRGB(74, 82, 84)
